...
heading: 'A simple reactive form'
---

<p style="font-size:30px;color:#8A97A8;line-height:1.4;margin:0 0 44px;max-width:1400px;">We construct a separate control tree, then bind controls from that tree into the template.</p>
<div style="background:#12171F;border:1px solid #4A5568;border-radius:14px;padding:36px 44px;font-family:&#x27;JetBrains Mono&#x27;,monospace;font-size:28px;line-height:1.65;color:#C9D4E2;"> <div><span style="color:#8B7CF6;">readonly</span> <span>loginForm</span> = <span style="color:#8B7CF6;">new</span> <span style="color:#7CC4FF;">FormGroup</span>({</div> <div style="padding-left:1.2em;">email: <span style="color:#8B7CF6;">new</span> <span style="color:#7CC4FF;">FormControl</span>(<span style="color:#2FD8B4;">''</span>),</div> <div style="padding-left:1.2em;">password: <span style="color:#8B7CF6;">new</span> <span style="color:#7CC4FF;">FormControl</span>(<span style="color:#2FD8B4;">''</span>),</div> <div>});</div> </div>
<div style="background:#12171F;border:1px solid #4A5568;border-radius:14px;padding:36px 44px;margin-top:28px;font-family:&#x27;JetBrains Mono&#x27;,monospace;font-size:28px;line-height:1.65;color:#C9D4E2;"> <div>&lt;input [formControl]=<span style="color:#2FD8B4;">"loginForm.controls.email"</span> /&gt;</div> <div>&lt;input [formControl]=<span style="color:#2FD8B4;">"loginForm.controls.password"</span> /&gt;</div> </div>
<p style="font-size:30px;color:#5E6B7D;line-height:1.4;margin:44px 0 0;">And for a form this simple, there really isn't much wrong with this.</p>
...
<div style="background:#0A0D12;border:1px solid #2FD8B4;border-radius:14px;padding:40px 56px;font-family:&#x27;JetBrains Mono&#x27;,monospace;font-size:38px;line-height:1.6;color:#E8ECF2;margin-bottom:52px;"> <div><span style="color:#7CC4FF;">required</span>(p.email, {</div> <div style="padding-left:1.2em;">when: ({ valueOf }) =&gt; <span style="background:#1E3A33;color:#2FD8B4;">valueOf(p.notify)</span>,</div> <div>});</div> </div>
...
<div style="border-left:4px solid #2FD8B4;padding-left:28px;font-family:&#x27;Space Grotesk&#x27;,sans-serif;font-size:40px;font-weight:500;color:#E8ECF2;">Describe the rule instead of orchestrating the response.</div>
